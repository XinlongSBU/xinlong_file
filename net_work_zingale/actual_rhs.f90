...
contains
  ...
  subroutine jac_nuc(dfdy_nuc, Y, screened_rates, dens)
    ...
    scratch_4 = screened_rates(k_p_p31__he4_si28)*dens
    scratch_5 = Y(jp31)*scratch_4
    scratch_6 = screened_rates(k_p_p31__s32)*Y(jp31)*dens
    scratch_7 = -scratch_5 - scratch_6
    scratch_8 = Y(jmg24)*dens
    scratch_9 = screened_rates(k_he4_mg24__p_al27)*scratch_8
    scratch_10 = Y(jsi28)*dens
    ...
    scratch_26 = screened_rates(k_he4_ne20__mg24)*Y(jne20)*dens
    scratch_27 = -scratch_26
    scratch_28 = screened_rates(k_he4_o16__ne20)*Y(jo16)*dens
    ...
    scratch_37 = screened_rates(k_o16_o16__he4_si28)*Y(jo16)*dens
