    ...
    if (slope_order .eq. 0) then
       ...
       do comp=1,nvar
          ...
          if (lo(1) .eq. domlo(1)) then
             if (adv_bc(1,1,comp) .eq. 3  .or. adv_bc(1,1,comp) .eq. 4) then
                slx(is-1,comp) = zero
          ...
          if (hi(1) .eq. domhi(1)) then
             if (adv_bc(1,2,comp) .eq. 3  .or. adv_bc(1,2,comp) .eq. 4) then
                slx(ie+1,comp) = zero
    ...
    if (slope_order .eq. 0) then
       ...
       do comp=1,nvar
          ...
          if (lo(2) .eq. domlo(2)) then
             if (adv_bc(2,1,comp) .eq. 3 .or. adv_bc(2,1,comp) .eq. 4) then
                do i = is-1,ie+1
          ...
          if (hi(2) .eq. domhi(2)) then
             if (adv_bc(2,2,comp) .eq. 3 .or. adv_bc(2,2,comp) .eq. 4) then
                do i = is-1, ie+1
