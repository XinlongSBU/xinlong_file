  ...
  subroutine ppm_1d(s,ng_s,u,ng_u,Ip,Im,domlo,domhi,lo,hi,adv_bc,dx,dt,is_umac)
    ...
    if (ppm_type .eq. 1) then
       ...
       if (lo(1) .eq. domlo(1)) then
          if (adv_bc(1,1) .eq. 3  .or. adv_bc(1,1) .eq. 4) then
       ...
       if (hi(1) .eq. domhi(1)) then
          if (adv_bc(1,2) .eq. 3  .or. adv_bc(1,2) .eq. 4) then
             ! the value in the first cc ghost cell represents the edge value
             sp(hi(1)) = s(hi(1)+1)
  ...
  subroutine ppm_2d(s,ng_s,u,v,ng_u,Ip,Im,domlo,domhi,lo,hi,adv_bc,dx,dt,is_umac)
    ...
    if (ppm_type .eq. 1) then
       ...
       if (lo(2) .eq. domlo(2)) then
          if (adv_bc(2,1) .eq. 3  .or. adv_bc(2,1) .eq. 4) then
             ! the value in the first cc ghost cell represents the edge value
       ...
       if (hi(2) .eq. domhi(2)) then
          if (adv_bc(2,2) .eq. 3  .or. adv_bc(2,2) .eq. 4) then
             ! the value in the first cc ghost cell represents the edge value
  ...
  subroutine ppm_3d(s,ng_s,u,v,w,ng_u,Ip,Im,domlo,domhi,lo,hi,adv_bc,dx,dt,is_umac)
    ...
    if (ppm_type .eq. 1) then
       ...
       if (lo(3) .eq. domlo(3)) then
          if (adv_bc(3,1) .eq. 3  .or. adv_bc(3,1) .eq. 4) then
             !
             ! The value in the first cc ghost cell represents the edge value.
             !
       ...
       if (hi(3) .eq. domhi(3)) then
          if (adv_bc(3,2) .eq. 3  .or. adv_bc(3,2) .eq. 4) then
             !
             ! The value in the first cc ghost cell represents the edge value.
             !
