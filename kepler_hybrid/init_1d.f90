...
program init_1d
  ...
  ! set the parameters
  model_file = "kepler_zingale_ONe6040-final.raw"
  ...
  ! print *, 'xzn_hse(1-6)', xzn_hse(1), xzn_hse(2), xzn_hse(3), xzn_hse(4), xzn_hse(5), xzn_hse(6)
  ! print *, 'xznl(1-6)', xznl(1), xznl(2), xznl(3), xznl(4), xznl(5), xznl(6)
  ...
  do i = 1, npts_model
     ...
     do j = 1, nvars_model_file
        ...
        case default
           ...
           ! print *, 'i=', i, 'j=', j, 'n=', n, 'trim(varnames_stored(j)) = ', trim(varnames_stored(j))
  ...
  ! print *, base_state(1,idens), base_state(1,itemp), base_state(1,ipres)
  ! print *, 'base_r(1-3)', base_r(1), base_r(2), base_r(3)
...
1000 format (1x, 12(g26.16, 1x))
  ...
  ! print *, 'FOUR3RD = ', FOUR3RD
  ! print *, 'M_PI = ', M_PI
  ! print *, 'model_kepler_hse(1,idens) = ', model_kepler_hse(1,idens)
