...
contains
  ...
  subroutine jac_nuc(state, Y, screened_rates)
    ...
    scratch_6 = screened_rates(k_p_al27__si28)*state % rho
    scratch_7 = Y(jal27)*scratch_6
    ...
    scratch_23 = screened_rates(k_p_p31__s32)*scratch_17
    scratch_24 = -scratch_22 - scratch_23
    scratch_25 = screened_rates(k_he4_al27__p31)*scratch_4
