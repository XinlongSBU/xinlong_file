...
contains
  ...
  subroutine jac_nuc(state, Y, screened_rates)
    ...
    scratch_26 = screened_rates(k_he4_ne20__mg24)*state % rho
    scratch_27 = Y(jne20)*scratch_26
    ...
    scratch = (&
      scratch_25 + scratch_28 + scratch_30 + scratch_31 + scratch_33 + &
      scratch_35 &
       )
