...
contains
  ...
  subroutine jac_nuc(state, jac, Y, screened_rates)
    ...
    scratch_0 = screened_rates(k_p_al27__he4_mg24)*state % rho
    scratch_1 = Y(jal27)*scratch_0
    scratch_2 = Y(jal27)*state % rho
    scratch_3 = screened_rates(k_p_al27__si28)*scratch_2
    scratch_4 = -scratch_1 - scratch_3
    scratch_5 = Y(jp31)*state % rho
    scratch_6 = screened_rates(k_p_p31__he4_si28)*scratch_5
    scratch_7 = screened_rates(k_p_p31__s32)*scratch_5
    ...
    scratch_17 = Y(jp)*scratch_0
    scratch_18 = Y(jp)*state % rho
    scratch_19 = screened_rates(k_p_al27__si28)*scratch_18
    scratch_20 = -scratch_17 - scratch_19
    scratch_21 = screened_rates(k_he4_si28__p_p31)*scratch_15
    scratch_22 = screened_rates(k_p_p31__he4_si28)*scratch_18
    scratch_23 = screened_rates(k_p_p31__s32)*scratch_18
    scratch_24 = -scratch_22 - scratch_23
    scratch_25 = screened_rates(k_he4_al27__p31)*scratch_2
    scratch_26 = -scratch_25
    scratch_27 = screened_rates(k_he4_ne20__mg24)*Y(jne20)*state % rho
    ...
    scratch_32 = -scratch_12
    scratch_33 = screened_rates(k_he4_si28__s32)*scratch_11
    scratch_34 = -scratch_33
    scratch_35 = screened_rates(k_he4_mg24__si28)*scratch_9
    scratch_36 = -scratch_10 - scratch_35
    scratch_37 = Y(jhe4)*scratch_29
    scratch_38 = -scratch_37
    scratch_39 = screened_rates(k_o16_o16__he4_si28)*Y(jo16)*state % rho
    scratch_40 = 1.0e0_rt*scratch_39
    scratch_41 = screened_rates(k_he4_ne20__mg24)*scratch_15
    scratch_42 = -scratch_41
    scratch_43 = screened_rates(k_he4_mg24__si28)*scratch_15
    scratch_44 = -scratch_16 - scratch_43
    scratch_45 = screened_rates(k_he4_al27__p31)*scratch_15
    scratch_46 = -scratch_45
    scratch_47 = screened_rates(k_he4_si28__s32)*scratch_15
    ...
    scratch = (&
      scratch_26 + scratch_28 + scratch_31 + scratch_32 + scratch_34 + &
      scratch_36 &
       )
    ...
    scratch = (&
      -2.0e0_rt*scratch_13 + scratch_38 - 2.0e0_rt*scratch_39 &
       )
    ...
    scratch = (&
      scratch_32 + scratch_34 + scratch_35 &
       )
