...
contains
  ...
  subroutine update_velocity(lo, hi, lev, &
    ...
    double precision, intent(in   ) :: uold(uo_lo(1):uo_hi(1),uo_lo(2):uo_hi(2),uo_lo(3):uo_hi(3),3)
    integer         , intent(in   ) :: un_lo(3), un_hi(3)
    double precision, intent(inout) :: unew(un_lo(1):un_hi(1),un_lo(2):un_hi(2),un_lo(3):un_hi(3),3)
    ...
    double precision, intent(in   ) :: uedgex (x_lo(1):x_hi(1),x_lo(2):x_hi(2),x_lo(3):x_hi(3),3)
    integer         , intent(in   ) :: y_lo(3), y_hi(3)
    double precision, intent(in   ) :: uedgey (y_lo(1):y_hi(1),y_lo(2):y_hi(2),y_lo(3):y_hi(3),3)
    integer         , intent(in   ) :: z_lo(3), z_hi(3)
    double precision, intent(in   ) :: uedgez (z_lo(1):z_hi(1),z_lo(2):z_hi(2),z_lo(3):z_hi(3),3)
    integer         , intent(in   ) :: f_lo(3), f_hi(3)
    double precision, intent(in   ) :: force(f_lo(1):f_hi(1),f_lo(2):f_hi(2),f_lo(3):f_hi(3),3)
    integer         , intent(in   ) :: s_lo(3), s_hi(3)
    double precision, intent(in   ) :: sponge (s_lo(1):s_hi(1),s_lo(2):s_hi(2),s_lo(3):s_hi(3))
    integer         , intent(in   ) :: w0_lo(3), w0_hi(3)
    double precision, intent(in   ) :: w0_cart(w0_lo(1):w0_hi(1),w0_lo(2):w0_hi(2),w0_lo(3):w0_hi(3),3)
    ...
    do k = lo(3),hi(3)
       do j = lo(2),hi(2)
          do i = lo(1),hi(1)
             ...
             w0bar = HALF*(w0_cart(i,j,k,3) + w0_cart(i,j,k+1,3))
