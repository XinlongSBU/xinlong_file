...
module cuvode_parameters_module
  ...
  ! integer work array of size 30 + NEQ. These are 1 constants
  ...
  ! For 1, LMAX = MAXORD + 1, so the following are specific
  ...
  ! IMPORTANT:
  ! Input sanitization in 1 has been removed for this for
