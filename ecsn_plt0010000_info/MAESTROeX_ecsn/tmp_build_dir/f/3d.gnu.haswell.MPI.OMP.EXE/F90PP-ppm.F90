       ...
       do k=lo(3),hi(3)
          do j=lo(2),hi(2)
             do i=lo(1),hi(1)
                ...
                ! Different stencil needed for x-component of 3 and 4 adv_bc's.
                !
                if (i .eq. domlo(1)) then
                   if (adv_bc(1,1,bccomp) .eq. 3  .or. adv_bc(1,1,bccomp) .eq. 4) then
                ...
                if (i .eq. domhi(1)) then
                   if (adv_bc(1,2,bccomp) .eq. 3  .or. adv_bc(1,2,bccomp) .eq. 4) then
       ...
       do k=lo(3),hi(3)
          do j=lo(2),hi(2)
             do i=lo(1),hi(1)
                ...
                !
                !
                ! Different stencil needed for y-component of 3 and 4 adv_bc's.
                !
                if (j .eq. domlo(2)) then
                   if (adv_bc(2,1,bccomp) .eq. 3  .or. adv_bc(2,1,bccomp) .eq. 4) then
                      !
                      ! The value in the first cc ghost cell represents the edge value.
                      !
                      sm = s(i,j-1,k,n)
                ...
                if (j .eq. domhi(2)) then
                   if (adv_bc(2,2,bccomp) .eq. 3  .or. adv_bc(2,2,bccomp) .eq. 4) then
                      !
                      ! The value in the first cc ghost cell represents the edge value.
                      !
                      sp = s(i,j+1,k,n)
       ...
       do k=lo(3),hi(3)
          do j=lo(2),hi(2)
             do i=lo(1),hi(1)
                ...
                !
                ! Different stencil needed for z-component of 3 and 4 adv_bc's.
                !
                if (k .eq. domlo(3)) then
                   if (adv_bc(3,1,bccomp) .eq. 3  .or. adv_bc(3,1,bccomp) .eq. 4) then
                ...
                if (k .eq. domhi(3)) then
                   if (adv_bc(3,2,bccomp) .eq. 3  .or. adv_bc(3,2,bccomp) .eq. 4) then
