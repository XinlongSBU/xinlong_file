       ...
       do comp=1,nvar
          ...
          do k = lo(3), hi(3)
             do j = lo(2),hi(2)
                ...
                if (adv_bc(1,1,bc_comp) .eq. 3  .or. adv_bc(1,1,bc_comp) .eq. 4) then
                ...
                if (adv_bc(1,2,bc_comp) .eq. 3  .or. adv_bc(1,2,bc_comp) .eq. 4) then
          ...
          do k = lo(3), hi(3)
             do j = lo(2),hi(2)
                do i = lo(1),hi(1)
                   ...
                   if (adv_bc(2,1,bc_comp) .eq. 3 .or. adv_bc(2,1,bc_comp) .eq. 4) then
                   ...
                   if (adv_bc(2,2,bc_comp) .eq. 3 .or. adv_bc(2,2,bc_comp) .eq. 4) then
          ...
          do k = lo(3),hi(3)
             do j = lo(2),hi(2)
                do i = lo(1),hi(1)
                   ...
                   if (adv_bc(3,1,comp) .eq. 3 .or. adv_bc(3,1,comp) .eq. 4) then
                   ...
                   if (adv_bc(3,2,comp) .eq. 3 .or. adv_bc(3,2,comp) .eq. 4) then
